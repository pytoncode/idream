...
def Onstart():
    ...
    r1 = question('réponse 1 ', 'I-DREAM QUIZZ 1.0')
    r2 = question('réponse 2', 'I-DREAM QUIZZ 1.0')
    r3 = question('réponse 3 ', 'I-DREAM QUIZZ 1.0')
    rc = question('réponse correcte = n° ', 'I-DREAM QUIZZ 1.0')
    list1.append(titre)
    list1.append(r1)
    list1.append(r2)
    list1.append(r3)
